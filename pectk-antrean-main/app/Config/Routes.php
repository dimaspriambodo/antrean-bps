...
// Tambahkan di bagian bawah kelompok ANTREAN
$routes->get('/(?i)antrean/(?i)display', 'Antrean::display'); // Halaman TV
$routes->get('/(?i)antrean/(?i)get_latest', 'Antrean::get_latest'); // Ambil data JSON
