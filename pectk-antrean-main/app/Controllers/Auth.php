...
class Auth extends BaseController
{
    ...
    public function index()
    {
        ...
        // Sesuaikan nilai variabel ini agar tulisan di View otomatis berubah
        $this->systemName = "Sistem Antrean Layanan";
        $this->systemSubtitleName = "BPS Kota Pekalongan";
        $this->companyName = "BPS Kota Pekalongan";

        $data = [
            'title' => 'Login - ' . $this->systemSubtitleName, // Judul di Tab Browser
            'users' => $users,
