...
<head>
    ...
    <style>
        ...
        @media (max-width: 767.98px) {
            ...
            /* Tambahkan di dalam <style> di dashboard.php */
            :root {
                --bps-blue: #004a8c;
                --bps-blue-light: #e6f0ff;
            }

            /* Memaksa header berwarna biru BPS */
            header.bg-success-subtle,
            .bg-success-subtle {
                background-color: var(--bps-blue-light) !important;
                border-bottom: 2px solid var(--bps-blue) !important;
            }

            header .text-success-emphasis,
            .text-success-emphasis {
                color: var(--bps-blue) !important;
            }

            /* Mengubah warna button toggle menu di mobile */
            .btn-outline-success {
                --bs-btn-color: var(--bps-blue);
                --bs-btn-border-color: var(--bps-blue);
                --bs-btn-hover-bg: var(--bps-blue);
                --bs-btn-active-bg: var(--bps-blue);
            }

            /* Mengubah warna garis vertikal (VR) */
...
<body class="bg-body-hwpweb user-select-none">
    <div class="wrapper">
        <!-- HEADER -->
        <!-- Cari Baris 377 dan GANTI MENJADI INI -->
        <header class="navbar sticky-top flex-md-nowrap p-0 shadow-sm bg-primary-subtle text-primary border-bottom border-primary-subtle header">
            <?php if (!(session()->get('role') == "Satpam" && $activeSegment === 'home')) : ?>
                <!-- Cari Baris 380-385 dan GANTI MENJADI INI -->
                <div id="sidebarHeader" class="d-flex justify-content-center align-items-center me-0 px-3 py-md-1" style="min-height: 48px; max-height: 48px;">
                    <span class="navbar-brand mx-0 text-start lh-sm d-flex justify-content-center align-items-center" style="font-size: 7.5pt;">
                        <img src="<?= base_url('/assets/images/logo_bps.png'); ?>" alt="BPS KOTA PEKALONGAN" height="24px">
                        <!-- Baris 406 -->
                        <div class="ps-2 text-start text-primary fw-bold">BADAN PUSAT STATISTIK<br>KOTA PEKALONGAN</div>
                    </span>
                </div>
                        ...
                        <div class="offcanvas-header pt-0 pb-0 d-flex justify-content-between align-items-center" style="min-height: 48px;">
                            <div>
                                <span class="navbar-brand mx-0 text-start text-md-center lh-sm d-flex justify-content-center align-items-center" style="font-size: 7.5pt;">
                                    <img src="<?= base_url('/assets/images/logo_bps.png'); ?>" alt="KLINIK MATA PECTK" height="24px">
                                    <div class="ps-2 text-start text-success-emphasis fw-bold">BPS<br>Kota Pekalongan</div>
                                </span>
                            </div>
